...
public class ClienteTest {
    ...
    void testConstructorAndGetters() {
        Cliente cliente = new Cliente("Empresa XYZ Cliente", "01/01/1980", 10000000, 98765432, "NombreDeDiezCaracteres", "ApellidoDeDiezCaracteres", "912345678", "Habitat", 1, "Calle Falsa 123", "Santiago", 40);
    ...
    void testSetRutValido() {
        Cliente cliente = new Cliente("EmpresaDeDiezCaracteres", "01/01/1990", 12345678, 11111111, "NombreDeDiezCaracteres", "ApellidoDeDiezCaracteres", "912345678", "AFPdeCINCO", 1, "Dir", "Com", 30);
    ...
    void testSetNombresInvalido_Corto(){
        ...
        assertTrue(exception.getMessage().contains("Los nombres son obligatorios y deben tener entre 5 y 30 caracteres."));
    }
